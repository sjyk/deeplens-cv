...
from deeplens.separate_manager.videoio import *
from deeplens.separate_manager.file import *
...
class SeparateStorageManager(StorageManager):
    ...
    def __init__(self, content_tagger, basedir, db_name='header.db'):
