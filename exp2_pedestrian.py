...
def runNaive(tot=1000, sel=0.1):
	...
	c = VideoStream('/Users/sanjaykrishnan/Downloads/TownCentreXVID.avi', limit=tot)
	sel = sel/2
...
def runSimple(tot=1000, sel=0.1):
	...
	manager.put('/Users/sanjaykrishnan/Downloads/TownCentreXVID.avi', 'test', args={'encoding': XVID, 'size': -1, 'sample': 1.0, 'offset': 0, 'limit': tot, 'batch_size': 20})
...
def runFull(tot=1000, sel=0.1):
	...
	manager.put('/Users/sanjaykrishnan/Downloads/TownCentreXVID.avi', 'test', args={'encoding': XVID, 'size': -1, 'sample': 1.0, 'offset': 0, 'limit': 1000, 'batch_size': 100})
